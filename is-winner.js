/*
Create a function named isWinner which accepts a string 
representing the name of a country. It should use the 
winners "API" to return a resolved Promise with an 
appropriate string.

The strings which can be returned are listed below. 
You'll need to replace "Country" with the country 

named which is passed to isWinner:

"Country never was a winner": The country has never won 
a FIFA world cup.

"Country is not what we are looking for because of 
the continent": The country is not from 
the european continent.

"Country is not what we are looking for because of 
the number of times it was champion": The country won 
the FIFA world cup fewer than 3 times.

"Country won the FIFA World Cup in <years> winning 
by <results>": with the following format:
